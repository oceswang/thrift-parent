 ...
 *  @generated
 */
package com.github.thrift.service1.order;
...
public class OrderService {
  ...
  public interface Iface {
    ...
    public OrderDTO getById(long id) throws org.apache.thrift.TException;

    public java.util.List<OrderDTO> search(OrderQuery query) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void getById(long id, org.apache.thrift.async.AsyncMethodCallback<OrderDTO> resultHandler) throws org.apache.thrift.TException;

    public void search(OrderQuery query, org.apache.thrift.async.AsyncMethodCallback<java.util.List<OrderDTO>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public OrderDTO recv_getById() throws org.apache.thrift.TException
    {
    ...
    public void send_search(OrderQuery query) throws org.apache.thrift.TException
    {
    ...
    public java.util.List<OrderDTO> recv_search() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getById_call extends org.apache.thrift.async.TAsyncMethodCall<OrderDTO> {
      private long id;
      public getById_call(long id, org.apache.thrift.async.AsyncMethodCallback<OrderDTO> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public OrderDTO getResult() throws org.apache.thrift.TException {
    ...
    public static class search_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<OrderDTO>> {
      private OrderQuery query;
      public search_call(OrderQuery query, org.apache.thrift.async.AsyncMethodCallback<java.util.List<OrderDTO>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.query = query;
      }
      ...
      public java.util.List<OrderDTO> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getById<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getById_args, OrderDTO> {
      public getById() {
        super("getById");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<OrderDTO> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<OrderDTO>() { 
          public void onComplete(OrderDTO o) {
            getById_result result = new getById_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getById_args args, org.apache.thrift.async.AsyncMethodCallback<OrderDTO> resultHandler) throws org.apache.thrift.TException {
        iface.getById(args.id,resultHandler);
      }
    }

    public static class search<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, search_args, java.util.List<OrderDTO>> {
      public search() {
        super("search");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<java.util.List<OrderDTO>> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<java.util.List<OrderDTO>>() { 
          public void onComplete(java.util.List<OrderDTO> o) {
            search_result result = new search_result();
            result.success = o;
            try {
              fcall.sendResponse(fb, result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, search_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<OrderDTO>> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class getById_result implements org.apache.thrift.TBase<getById_result, getById_result._Fields>, java.io.Serializable, Cloneable, Comparable<getById_result>   {
    ...
    public OrderDTO success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, OrderDTO.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public getById_result(getById_result other) {
      if (other.isSetSuccess()) {
        this.success = new OrderDTO(other.success);
      }
    }
    ...
    public OrderDTO getSuccess() {
      return this.success;
    }

    public getById_result setSuccess(OrderDTO success) {
      this.success = success;
      return this;
    }
  ...
  public static class search_args implements org.apache.thrift.TBase<search_args, search_args._Fields>, java.io.Serializable, Cloneable, Comparable<search_args>   {
    ...
    public OrderQuery query; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.QUERY, new org.apache.thrift.meta_data.FieldMetaData("query", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, OrderQuery.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public search_args(search_args other) {
      if (other.isSetQuery()) {
        this.query = new OrderQuery(other.query);
      }
    }
    ...
    public search_args setQuery(OrderQuery query) {
      this.query = query;
      return this;
    }
  ...
  public static class search_result implements org.apache.thrift.TBase<search_result, search_result._Fields>, java.io.Serializable, Cloneable, Comparable<search_result>   {
    ...
    public java.util.List<OrderDTO> success; // required
    ...
    public search_result(
      java.util.List<OrderDTO> success)
    {
      this();
      this.success = success;
    }
    ...
    public search_result(search_result other) {
      if (other.isSetSuccess()) {
        java.util.List<OrderDTO> __this__success = new java.util.ArrayList<OrderDTO>(other.success.size());
        for (OrderDTO other_element : other.success) {
          __this__success.add(new OrderDTO(other_element));
        }
    ...
    public java.util.Iterator<OrderDTO> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(OrderDTO elem) {
      if (this.success == null) {
        this.success = new java.util.ArrayList<OrderDTO>();
      }
      this.success.add(elem);
    }

    public java.util.List<OrderDTO> getSuccess() {
      return this.success;
    }

    public search_result setSuccess(java.util.List<OrderDTO> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((java.util.List<OrderDTO>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<OrderDTO>(_list0.size);
                  OrderDTO _elem1;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, search_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (OrderDTO _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (OrderDTO _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<OrderDTO>(_list5.size);
            OrderDTO _elem6;
